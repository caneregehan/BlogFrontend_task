  ...
  return (
    <Disclosure as="nav">
      <div className="mx-auto max-w-7xl">
        <div className="absolute z-50 flex items-center justify-between h-16 gap-36">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
              className="relative p-1 text-white bg-transparent rounded-full hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 ">
