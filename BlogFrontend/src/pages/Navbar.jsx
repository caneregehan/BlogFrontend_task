    ...
    <Disclosure as="nav" className="bg-transparent">
      <div className="mx-auto max-w-7xl">
        <div className="relative flex items-center justify-between h-16">
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current
                        ? "hover:bg-gray-400 hover:text-white text-black"
          ...
          <div className="mr-48">
            <input className="text-3xl bg-gray-300 rounded-3xl" type="text" />
          </div>
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
              className="relative p-1 text-gray-600 bg-transparent rounded-full hover:text-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-800 focus:ring-offset-2 focus:ring-offset-gray-800">
